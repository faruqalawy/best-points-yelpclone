...
async function seedPlaces() {
  const places = [
    {
      ...
      image:
        "https://img.freepik.com/free-photo/wide-angle-shot-single-tree-growing-clouded-sky-sunset-surrounded-by-grass_181624-22807.jpg?t=st=1723859771~exp=1723863371~hmac=58bfa705c2e021992b0705aa58555509778030c7edfc118bd88c626eb665cef5&w=1060",
    },
    {
      title: "Pantai Kuta",
      price: 0,
  ...
  const newPlace = await Promise.all(places.map(async (place) => {
    ...
    return {
      ...place,
      author: "66c4949764d8687deccbfd69",
      images: {
        url: "public\\images\\image-1724507045626-912487927.jpg",
        filename: "image-1724507045626-912487927.jpg",
      },
      geometry: {...geoData}
    };
  }));
